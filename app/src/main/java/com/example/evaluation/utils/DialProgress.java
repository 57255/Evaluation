...
import com.example.evaluation.BuildConfig;
...
public class DialProgress extends View {
    ...
    //渐变
    private int[] mGradientColors = {Color.BLUE, Color.BLUE, Color.BLUE};
    //当前进度，[0.0f,1.0f]
    ...
    private void initPaint() {
        ...
        mHintPaint.setTypeface(Typeface.SERIF);
    ...
    private void drawText(Canvas canvas) {
        ...
        if (mUnit != null) {
            canvas.drawText(mUnit.toString(), mCenterPoint.x, mUnitOffset+70, mUnitPaint);
        }

        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mHintOffset-70, mHintPaint);
        }
    }
