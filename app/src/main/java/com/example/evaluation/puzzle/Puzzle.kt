...
class Puzzle : View {
    ...
    private fun createPath() {
        ...
        if(1 in gapArray) {
            path.arcTo(
                RectF(randomX * mWidth + 0.2f * sideLength, randomY * mHeight - 0.2f * sideLength,
        ...
        if(2 in gapArray) {
            path.arcTo(
                RectF(randomX * mWidth + 0.8f * sideLength, randomY * mHeight + 0.2f * sideLength,
        ...
        if(3 in gapArray){
            path.arcTo(
                RectF(randomX * mWidth + 0.2f * sideLength, randomY * mHeight + 0.8f * sideLength,
        ...
        if (4 in gapArray) {
            path.arcTo(
                RectF(randomX * mWidth - 0.2f * sideLength, randomY * mHeight + 0.4f * sideLength,
